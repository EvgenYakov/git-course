...
// Подумайте, как сделать шаблон, который бы различал эти два вида использования 
// кавычек и создайте вызов метода replace, который бы выполнял
// правильную замену.
...
// Change this call.
console.log(text.replace(/^'|'(\W)|(\W)'|'$/g, "$2\"$1"));
